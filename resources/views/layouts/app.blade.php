        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <div class="flex items-center justify-center mt-4 mb-3">
                <div class="flex items-center">
                    ...
                    <span class="text-white text-2xl mx-2 font-semibold">Divisi SDI</span>
                </div>
            </div>
            ...
            <nav class="mt-4">
                ...
                <p class="py-2 px-6 text-gray-500 text-bold">Surat</p>
                <a class="flex items-center py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/letters*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' :  'text-gray-500' }}" href="{{ route('admin.letters.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a3 3 0 01-3.144 0L1.5 8.67z" />
                        <path d="M22.5 6.908V6.75a3 3 0 00-3-3h-15a3 3 0 00-3 3v.158l9.714 5.978a1.5 1.5 0 001.572 0L22.5 6.908z" />
                      </svg>
                      
                    <span class="mx-3">Memo Intern</span>
                </a>
                <a class="flex items-center py-2 px-6 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 {{ Request::is('admin/profile*') ? ' bg-gray-700 bg-opacity-25 text-gray-100' :  'text-gray-500' }}" href="{{ route('admin.profile.index') }}">
                    ...
                    <span class="mx-3">Surat Pemberitahuan</span>
                </a>
